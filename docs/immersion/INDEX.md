...
| 04 | Floor Descent Ceremony | mid-term | M | MED | game-logic + ui-agent | none | **partial** (game-logic done, UI pending) |
...
| 09 | ~~Dynamic Dungeon Mood~~ | ambitious | L | HIGH | game-logic | 01, 03, 05 | **done** |
