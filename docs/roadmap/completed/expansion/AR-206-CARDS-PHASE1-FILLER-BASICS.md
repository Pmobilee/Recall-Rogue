...
- [x] 1. Add Power Strike mechanic definition
...
- [x] 2. Add Twin Strike mechanic definition
...
- [x] 3. Add Iron Wave mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 4. Add Reinforce mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`
...
- [x] 5. Add Shrug It Off mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 6. Add Bash mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 7. Add Guard mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`
...
- [x] 8. Add Sap mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 9. Add Rupture mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 10. Add Lacerate mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 11. Add Kindle mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 12. Add Ignite mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 13. Add Overcharge mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 14. Add Riposte mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 15. Add Absorb mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 16. Add Reactive Shield mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 17. Add Sift mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 18. Add Scavenge mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 19. Add Precision Strike mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 20. Add Stagger mechanic definition
...
- [x] 21. Add Inscription of Fury mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 22. Add Inscription of Iron mechanic definition
...
- [x] 23. Add Corrode mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 24. Add Swap mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 25. Add Siphon Strike mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 26. Add Aegis Pulse mechanic definition
  **Files:** `src/data/mechanics.ts`, `src/services/cardUpgradeService.ts`, `src/services/cardEffectResolver.ts`
...
- [x] 27. Update headless simulator with all 30 new mechanics
...
- [x] 24. Add unit tests for all new mechanics
...
- [x] 25. Update inspection registry
...
- [x] 26. Visual verification of new cards
