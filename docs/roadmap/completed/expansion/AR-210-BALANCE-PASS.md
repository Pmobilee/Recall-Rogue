...
- [x] 1. Update headless sim bot profiles for new archetypes
...
- [x] 2. Run full balance simulation — 1000 runs per profile
...
- [x] 3. Analyze win rates against targets
...
- [x] 4. Run degenerate combo check
...
- [x] 6. Tune outlier values if needed
...
- [x] 7. Cursed Card system balance check
...
- [x] 8. Generate final balance report
