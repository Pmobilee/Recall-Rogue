...
|----------|----------------|-------------|-------|
| **Warcry** | +1 Strength (this turn) | +`str` Strength (permanent) + free next Charge | L0 `str=1`; L1=+2, L4–L5=+3. L3+ also grants free Charge on QP (`warcry_freecharge`). |
...
| **Hemorrhage** | 4 dmg + (4 per Bleed stack), consumes all Bleed | Standard CC pipeline | L0 qpValue bumped 2→4 in L0 Balance Overhaul. |
...
| `warcry` | L5 | Strength becomes **permanent** even on QP; CC: +3 Str permanent + free Charge |
