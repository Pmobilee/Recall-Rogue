...
> **Last verified:** 2026-04-23 (CoopLootSummary.svelte removed — dead code, zero callers. TriviaRoundScreen: added waiting-phase else branch for softlock prevention. RaceResultsScreen: single-player fallback when opponent disconnected.)
