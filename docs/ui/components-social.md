...
> **Last verified:** 2026-04-20 (Added error banner for lobby create/join failures in `CardApp.svelte`. Added visibility picker to Create tab. Added PlayerRosterPanel for 3+ player modes.)
