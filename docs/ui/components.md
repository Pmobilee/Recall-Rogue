...
| `DungeonEntrance.svelte` | Dungeon entry screen with parallax transition and language selection. **z-index (2026-04-12):** `.onboarding-screen` raised from `120` → `10001` so it renders above `ParallaxTransition` (z-index 9999 while settling). |
