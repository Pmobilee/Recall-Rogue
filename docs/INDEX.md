...
| [visual-verification/](testing/visual-verification/INDEX.md) | 885-item verification checklist — 8 domain files across 3 phases (core math, visual regression, depth coverage) |
