/**
 * Playtest Log Analyzer — Batch C (7 logs: struggling + veteran-expert)
 * Reads each log, applies the 9-issue analysis checklist, writes report JSON files.
 */
const fs = require('fs');
...
const TARGET_FILES = [
  'playthrough-struggling-100-1773154387099.json',
  'playthrough-struggling-200-1773154391928.json',
  'playthrough-struggling-400-1773154396381.json',
  'playthrough-struggling-42-1773154383110.json',
  'playthrough-struggling-600-1773154401488.json',
  'playthrough-veteran-expert-100-1773154447376.json',
  'playthrough-veteran-expert-700-1773154451440.json',
];
