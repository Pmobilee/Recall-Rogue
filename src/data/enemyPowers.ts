...
export const ENEMY_POWERS: Record<string, EnemyPowerDef> = {
  ...
  onPlayerChargeWrong: {
    ...
    label: 'Punish Wrong',
    color: '#e74c3c',
    tooltip: 'Reacts when you answer incorrectly',
  },
  onPlayerChargeCorrect: {
    id: 'punish_correct',
    label: 'Punish Correct',
    color: '#e67e22',
    tooltip: 'Reacts when you answer correctly',
  },
  onPlayerNoCharge: {
    id: 'punish_skip',
    label: 'Punish Skip',
    color: '#e67e22',
    tooltip: 'Escalates if you don\'t Charge this turn',
  },
  onEnemyTurnStart: {
    id: 'escalates',
    label: 'Escalates',
    color: '#e74c3c',
    tooltip: 'Grows stronger each turn',
  },
  phaseTransitionAt: {
    id: 'phase_transition',
    label: 'Phase 2',
