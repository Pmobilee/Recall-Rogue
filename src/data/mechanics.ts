...
export const MECHANIC_DEFINITIONS: MechanicDefinition[] = [
  ...
  { id: 'thorns', name: 'Thorns', type: 'shield', description: 'Gain block and retaliate.', baseValue: 6, apCost: 2, maxPerPool: 0, secondaryValue: 2, tags: ['retaliate'], launchPhase: 1 },

  // Shield (phase 2)
  { id: 'fortify', name: 'Fortify', type: 'shield', description: 'Block persists into next turn.', baseValue: 5, apCost: 2, maxPerPool: 0, tags: ['persistent_block'], launchPhase: 2 },
  ...
  { id: 'overheal', name: 'Overheal', type: 'shield', description: 'Gain block. +50% if HP below half.', baseValue: 9, apCost: 2, maxPerPool: 0, tags: ['overheal'], launchPhase: 2 },
  ...
  // Buff (phase 2)
  { id: 'double_strike', name: 'Double Strike', type: 'buff', description: 'Next attack hits twice at 60%.', baseValue: 60, apCost: 2, maxPerPool: 0, tags: ['double_strike'], launchPhase: 2 },
  ...
  // Wild (phase 2)
  { id: 'overclock', name: 'Overclock', type: 'wild', description: 'Next card 2x, next draw -1.', baseValue: 2, apCost: 2, maxPerPool: 0, tags: ['overclock'], launchPhase: 2 },
];
