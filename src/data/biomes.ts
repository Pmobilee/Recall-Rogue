...
export const ALL_BIOMES: Biome[] = [
  ...
  makeBiome({
    ...
    tier: 'mid',
    layerRange: [6, 10],
    gaiaEntryComment: 'Columnar basalt. Lava cooled and fractured into hexagonal prisms. Geometry encoded in stone.',
  ...
  makeBiome({
    ...
    tier: 'mid',
    layerRange: [6, 10],
    gaiaEntryComment: 'Granite cools slowly, deep in the crust. This rock was never meant to be a surface. It still isn\'t, quite.',
  ...
  makeBiome({
    ...
    tier: 'mid',
    layerRange: [6, 10],
    gaiaEntryComment: 'Hydrothermal vents. The organisms here are chemosynthetic — sunlight is irrelevant to them.',
  ...
  makeBiome({
    ...
    tier: 'extreme',
    layerRange: [16, 20],
    gaiaEntryComment: 'The iron-nickel core begins 2,890 km down. You are not there. But you can feel it.',
  ...
  makeBiome({
    ...
    tier: 'extreme',
    layerRange: [16, 20],
    gaiaEntryComment: 'Extremophile colonies. They have been in the dark so long they started making their own light.',
  ...
  makeBiome({
    ...
    tier: 'extreme',
    layerRange: [16, 20],
    gaiaEntryComment: 'A fault boundary. Two tectonic plates ground together here. The rock remembers it.',
  ...
  makeBiome({
    ...
    layerRange: [1, 20],
    anomalyChance: 0.10,
    gaiaEntryComment: 'Luciferin oxidation. The darkness here is not empty — it is full of something that chose to glow.',
  ...
  makeBiome({
    ...
    layerRange: [1, 20],
    anomalyChance: 0.08,
    gaiaEntryComment: 'No echoes. My acoustic monitoring returns nothing. This cavity has been sealed for 400 million years.',
