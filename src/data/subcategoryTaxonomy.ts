...
export const SUBCATEGORY_TAXONOMY: Partial<Record<CanonicalFactDomain, SubcategoryDef[]>> = {
  ...
  mythology_folklore: [
    { id: 'afrocaribbean', label: 'Afro-Caribbean Religions', description: 'Vodou, Candomblé, Santería, and related traditions' },
    { id: 'bahai', label: "Bahá'í Faith", description: "Bahá'í teachings, history, and core principles" },
    ...
    { id: 'confucianism', label: 'Confucianism', description: 'Confucian philosophy, ethics, and cultural influence in East Asia' },
    ...
    { id: 'indigenous', label: 'Indigenous Religions', description: 'Native and indigenous spiritual traditions from around the world' },
    { id: 'jainism', label: 'Jainism', description: 'Jain philosophy, non-violence principles, and key figures' },
    { id: 'new_religious', label: 'New Religious Movements', description: 'Modern spiritual and religious movements outside traditional faiths' },
    ...
    { id: 'rastafari', label: 'Rastafari', description: 'Rastafarian beliefs, history, and cultural traditions' },
    { id: 'shinto', label: 'Shinto', description: 'Japanese Shinto kami, rituals, shrines, and spiritual traditions' },
    { id: 'sikhism', label: 'Sikhism', description: 'Sikh teachings, Gurus, the Granthal Sahib, and the Five Ks' },
    { id: 'taoism', label: 'Taoism', description: 'Taoist philosophy, the Tao Te Ching, and Chinese spiritual traditions' },
    { id: 'world_religions', label: 'World Religions', description: 'Comparative religion, religious history, and major faiths worldwide' },
    { id: 'yoruba', label: 'Yoruba Tradition', description: 'Yoruba spiritual beliefs, orishas, and West African religious traditions' },
    { id: 'zoroastrianism', label: 'Zoroastrianism', description: 'Zoroastrian theology, the Avesta, and Persian religious heritage' },
  ],
  animals_wildlife: [
